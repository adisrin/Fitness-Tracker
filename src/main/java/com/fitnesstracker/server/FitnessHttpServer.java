...
import com.fitnesstracker.handler.ClaudeApiHandler;
import com.fitnesstracker.handler.DirectChatHandler;
...
public class FitnessHttpServer {
    public static void start(int port) throws Exception {
        ...
        server.createContext("/fitness-tracker/api/ask", new ClaudeApiHandler());
        server.createContext("/fitness-tracker/api/direct-chat", new DirectChatHandler());
